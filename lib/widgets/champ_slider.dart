...
import 'package:paladins_app/providers/champImageProvider.dart';
      ...
      child: Column(
        ...
        children: [
          Padding(
            ...
            child: Text( title , style: TextStyle(fontSize: 19, fontWeight: FontWeight.w500),  overflow: TextOverflow.ellipsis, maxLines: 2)
          ),
        ...
        children: [
          ...
          ClipRRect(
            ...
            child: FadeInImage(
              ...
              image: NetworkImage('${ChampImageProvider.urlChampProvider(int.parse(championRankResponse.championId))}'),
              fit: BoxFit.cover,  
            ),
          ),
          SizedBox(height: 3),
