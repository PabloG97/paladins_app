...
class DataAnalyzer {
  ...
  static getImageRole( String champion){
      ...
      if(champion == 'Azaan' ||champion == 'Ash' || champion == 'Atlas' || champion == 'Barik' || champion == 'Fernando' || champion == 'Inara' || champion == 'Khan' || champion == 'Makoa' || champion == 'Raum' || champion == 'Ruckus' || champion == 'Terminus' || champion == 'Terminus' || champion == 'Torvald' ||  champion == 'Yagorath'){
      ...
      }else if( champion == 'VII' || champion == 'Androxus' || champion == 'Buck' || champion == 'Evie' || champion == 'Koga' || champion == 'Lex' || champion == 'Maeve' || champion == "Moji" || champion == 'Skye' || champion == 'Talus' || champion == 'Vatu' || champion == 'Vora' || champion == 'Zhin'){
        
        return 'assets/img/Flank_Icon.png';
     
      }else if(champion == 'Saati' || champion == 'Bomb King' || champion == 'Cassie' || champion == 'Dredge' || champion == 'Drogoz' || champion == 'Imani' || champion == 'Kinessa' || champion == "Lian" || champion == 'Octavia' || champion == 'Sha Lin' || champion == 'Strix' || champion == 'Tiberius' || champion == 'Tyra' || champion == 'Viktor' || champion == 'Vivian' || champion == 'Willo'){
